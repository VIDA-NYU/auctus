...
from auctus_core import common
...
class TestDatasetIdEncoding(unittest.TestCase):
    def test_encode(self):
        ...
        self.assertEqual(
            common.encode_dataset_id('auctus_contrived/dataset#id;'),
            'auctus__contrived_2Fdataset_23id_3B',
        )

    def test_decode(self):
        """Test decoding a file name to a dataset ID"""
        self.assertEqual(
            common.decode_dataset_id('auctus__contrived_2Fdataset_23id_3B'),
            'auctus_contrived/dataset#id;',
        )
