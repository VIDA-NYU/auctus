...
setup(name='datamart-isi-discovery-service',
      version='0.0',
      py_modules=['isi_discovery'],
      install_requires=req,
      description="ISI Datamart discovery service for Auctus",
      author="Remi Rampin",
      ...
      long_description="ISI Datamart discovery service for Auctus",
      license='Apache-2.0',
