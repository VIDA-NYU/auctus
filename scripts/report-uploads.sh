...
# Query elasticsearch
RECORD="$(curl -s -H content-type:application/json -d '{"query":{"bool":{"should":[{"term":{"materialize.identifier":"datamart.url"}},{"term":{"materialize.identifier":"datamart.upload"}}]}}, "_source":["date", "name"]}' http://localhost:8020/_search?size=1000 \
